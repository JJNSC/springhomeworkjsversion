...
<ul class="nav flex-column">
   ...
   <li class="nav-item mb-2">
    ...
    <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch03/content">요청 매핑(처리) 메소드의 매개변수 (RequestMapping)</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch08/content">세션(session) 이용</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch12/content">객체생성(싱글톤) 및 의존 주입</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch13/content">Service 와 DAO(data access object)</a>
      </h6>
   </li>
</ul>